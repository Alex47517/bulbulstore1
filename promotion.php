...
<html>
<head>
    <?php $title = 'Акции | BulBul'; require 'parts/head.php'; ?>
    <!-- Facebook Pixel Code -->
<script>
...
<section id="category">
    <div class="container">
        <div class="row py-4">
            <div class="col-12">
                <a href="/" class="breadcrumb-main-h3">Главная > </a><a href="promotion.php" class="breadcrumb-h3">Акции > </a>
            </div>
        </div>
    </div>
    <div class="category-block">
    <div class="container">
        <h3 class="category-h3 med-pad"><?php echo $category['name']; ?></h3>
        <div class="container">
   <div class="row">
        <div class="row pb-3 pb-md-5 order-2">
            ...
            $max = 0;
            $min = 0;
            	$product = array_values(R::getAll('SELECT * FROM newproducts WHERE old_sum ORDER by sum'));
            	for ($i=0; $product[$i]; $i++) { 
...
<button onclick="filterElements()" class="btn col-2 offset-1">ОК</button>
                  ...
                  $href = 'product.php?name='.$product[$i]['url_name'];
            			echo '<div class="col-12 col-md-6 col-lg-4 col-xl-3 pb-3 pb-md-0 mb-5 box" data-price="'.$product[$i]['sum'].'">
